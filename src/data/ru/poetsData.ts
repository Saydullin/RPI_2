const poets: {
...
}[] = [
    {
        id: 0,
        name: "Якуб Колас",
        description: "Белорусский советский писатель, драматург, поэт и переводчик, общественный деятель. Один из классиков и основоположников новой белорусской литературы. Народный поэт Белорусской ССР",
        ytLink: "https://www.youtube.com/embed/HxFeWGZspJQ?controls=0",
        years: {
            birth: 1882,
            death: 1956,
        },
        profileImage: {
            src: "/RPI_2/RPI_2/img/poets/poet_1.jpg",
            alt: "Yakub Kolas"
        },
        locationCoordinates: {
            lat: 0,
